...
namespace TVRename
{
    public class Episode
    {
        ...
        public Episode([NotNull] XElement r)
        {
            ...
            Overview = System.Net.WebUtility.HtmlDecode(XmlHelper.ReadStringFixQuotesAndSpaces(r.ExtractString("Overview")));
            ...
            mName = System.Net.WebUtility.HtmlDecode(XmlHelper.ReadStringFixQuotesAndSpaces(r.ExtractString("EpisodeName")));
        ...
        private void LoadJson(int seriesId, [NotNull] JObject bestLanguageR, JObject backupLanguageR)
        {
            ...
            {
                mName = System.Net.WebUtility.HtmlDecode((string) backupLanguageR["episodeName"]);
            }
        ...
        public string Name
        {
            ...
            set => mName = System.Net.WebUtility.HtmlDecode(value);
        }
