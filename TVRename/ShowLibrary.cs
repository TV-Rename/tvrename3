...
namespace TVRename
{
    ...
    public class ShowLibrary : ConcurrentDictionary<int, ShowItem>
    {
        ...
        public ObservableCollection<ShowItem> UIShows => new ObservableCollection<ShowItem>(Shows);
        ...
        public ICollection<SeriesSpecifier> SeriesSpecifiers
        {
            get
            {
                ...
                {
                    value.Add(new SeriesSpecifier(this,series.Key,series.Value.UseCustomLanguage,series.Value.CustomLanguageCode,series.Value.ShowName));
                }
