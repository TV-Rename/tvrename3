...
namespace TVRename.Ipc
{
    ...
    internal class RemoteClient : MarshalByRefObject, IRemoteActions
    {
        ...
        public static void Bind(MainWindow form, TVDoc settings)
        {
            MainUi = form;
            Engine = settings;
        ...
        {
            //MainUi?.Invoke((MethodInvoker)MainUi.FocusWindow);
        }
        ...
        public void Scan()
        {
            //MainUi?.Invoke((MethodInvoker)MainUi.Scan);
        }
        ...
        {
            //MainUi?.Invoke((MethodInvoker)MainUi.RecentScan);
        }
        ...
        {
            //MainUi?.Invoke((MethodInvoker)MainUi.QuickScan);
        }
        /// <summary>
        ...
        {
            //MainUi?.Invoke((MethodInvoker)MainUi.ProcessAll);
        }
        ...
        public void Quit()
        {
            //MainUi?.Invoke((MethodInvoker)MainUi.Quit);
        }
    }
}
